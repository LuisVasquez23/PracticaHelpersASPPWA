...
namespace WebMVC_PWA.Controllers
{
    public class marcasController : Controller
    {
        ...
        public marcasController(EquipoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.marcas != null ? 
                          ...
                          Problem("Entity set 'EquipoContext.marcas'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("id_marcas,nombre_marca,estado")] marcas marcas)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EquipoContext.marcas'  is null.");
            }
            var marcas = await _context.marcas.FindAsync(id);
            if (marcas != null)
            {
